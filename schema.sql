CREATE TABLE Users (id SERIAL PRIMARY KEY, username VARCHAR, password VARCHAR, role VARCHAR, visible BOOLEAN);
CREATE TABLE RoleRequests (id SERIAL PRIMARY KEY, username VARCHAR, message TEXT, sent VARCHAR);
CREATE TABLE Courses (id SERIAL PRIMARY KEY, tag VARCHAR, name VARCHAR, credits INT, open BOOLEAN, visible BOOLEAN);
